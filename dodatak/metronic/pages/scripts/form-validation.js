var FormValidation = function () {
    ...
    var handleValidation1 = function() {
        // for more info visit the official plugin documentation:
            ...
            var formlar = $('.form_sample_1');

			$.each(formlar,function(index,value){
				var form1 = $(value);
				...
				form1.validate({
					...
					messages: {
						...
						digits: "Lütfen sadece tek haneli rakam giriniz",
					...
					submitHandler: function (form) {
						var funcName = $(form).attr("cbfunc");
						if(funcName != "" && typeof window[funcName] == "function")
							window[funcName](form);
						success1.show();
						error1.hide();
					}
				});
