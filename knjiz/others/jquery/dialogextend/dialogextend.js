  ...
  $.widget("ui.dialogExtend", {
    ...
    _initStyles: function() {
      ...
      if (!$(".dialog-extend-css").length) {
        ...
        style += '.ui-dialog .ui-dialog-titlebar-restore { width: 20px; height: 20px; margin-right: 3px;}';
  ...
  $.extend(true, $.ui.dialogExtend.prototype, {
    ...
    _initStyles_collapse: function() {
      ...
      if (!$(".dialog-extend-collapse-css").length) {
        ...
        style += '.ui-dialog .ui-dialog-titlebar-collapse { width: 20px; height: 20px; margin-right: 3px;}';
  ...
  $.extend(true, $.ui.dialogExtend.prototype, {
    ...
    _initStyles_maximize: function() {
      ...
      if (!$(".dialog-extend-maximize-css").length) {
        ...
        style += '.ui-dialog .ui-dialog-titlebar-maximize { width: 20px; height: 20px; margin-right: 3px;}';
  ...
  $.extend(true, $.ui.dialogExtend.prototype, {
    ...
    _initStyles_minimize: function() {
      ...
      if (!$(".dialog-extend-minimize-css").length) {
        ...
        style += '.ui-dialog .ui-dialog-titlebar-minimize { width: 20px; height: 20px; margin-right: 3px;}';
