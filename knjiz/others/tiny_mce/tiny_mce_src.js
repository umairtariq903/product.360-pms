...
(function(tinymce) {
	...
	var libs = KNJIZ_URL ? KNJIZ_URL : 'knjiz';
	if ($('BASE').length > 0)
	{
		var base = $('BASE').attr('href');
		if (base.charAt(base.length - 1) != '/')
			base += '/';
		tinymce.baseURL = base + libs + '/others/tiny_mce/';
	}
	else
		tinymce.baseURL = tinymce.documentBaseURL + libs + '/others/tiny_mce/' ; //new tinymce.util.URI(tinymce.documentBaseURL).toAbsolute(tinymce.baseURL);
